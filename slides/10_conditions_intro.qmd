...
## Basic operators^[See more [here](https://docs.mysurvey.solutions/syntax-guide/cslanguage/syntax-guide-operators/). For example, the [ternary operator](https://docs.mysurvey.solutions/syntax-guide/cslanguage/syntax-guide-operators/#other) is quite useful.] {.t4}
